...
Order and structure tasks so that implementing them in sequence produces a working, demoable MVP as early as possible — not just a pile of tasks that only add up to something functional once every last one is done. Two goals:
...
2. Once every task is complete, the application is fully functional and meets the requirements of the brief.
